...
export const StatusBar: Component = () => {
  ...
  return (
    <div class="shrink-0 h-6 flex items-center px-3 border-t border-surface-3 bg-surface text-[11px] font-mono select-none">
      ...
      <div class="ml-auto flex items-center gap-3">
        <span class="text-muted-foreground">{currentTab()?.language || 'plaintext'}</span>
        <span class="text-muted-foreground">UTF-8</span>
        <span class="text-muted-foreground">Spaces: 2</span>
